...
const int pauseDurationOut = 3000;    // Duration of the breathing in exercise in milliseconds
...
void loop() {
  ...
  unsigned long touchValue = digitalRead(TOUCHPIN);

  if (touchValue == LOW) {  // While the person is touching the sensor this action starts
